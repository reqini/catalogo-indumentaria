...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <aside className="fixed left-0 top-0 z-50 h-full w-64 border-r border-gray-200 bg-white">
        <div className="p-6">
          <h1 className="mb-8 text-xl font-bold text-black">Admin Panel</h1>
        ...
        <div className="absolute bottom-0 left-0 right-0 border-t border-gray-200 p-6">
          <button
            ...
            className="flex w-full items-center gap-3 rounded-lg px-4 py-3 text-gray-600 transition-colors hover:bg-gray-100"
          >
            <LogOut size={20} />
